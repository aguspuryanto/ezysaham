---
title: "Saham AI Indonesia: Daftar Emiten Terkait Kecerdasan Buatan di BEI"
description: "Mengenal 7 saham di Bursa Efek Indonesia (BEI) yang memiliki eksposur terhadap tren kecerdasan buatan (AI), mulai dari pengembangan LLM lokal hingga penyedia infrastruktur data center."
date: "2026-09-05"
author: "Tim EzySaham AI"
---

## Saham AI Indonesia: Siapa Saja Pemainnya?

Tren Kecerdasan Buatan (AI) telah menjadi pendorong utama pasar saham global, dan gelombangnya kini semakin terasa di Indonesia. Meski Bursa Efek Indonesia (BEI) belum memiliki perusahaan yang 100% *pure-play* di bidang AI, terdapat sejumlah emiten teknologi dan telekomunikasi yang mulai menanamkan pijakan kuat di ekosistem AI nasional.

Berikut adalah daftar 7 saham AI di Indonesia yang teridentifikasi memiliki eksposur terhadap kecerdasan buatan, mulai dari pengembangan model bahasa lokal, infrastruktur komputasi, hingga solusi *enterprise*.

---

### 1. PT Indosat Ooredoo Hutchison Tbk (ISAT) & PT GoTo Gojek Tokopedia Tbk (GOTO)
**Fokus: Pengembangan LLM Lokal (Sahabat-AI)**

Kolaborasi strategis antara ISAT dan GOTO melahirkan **Sahabat-AI**, sebuah ekosistem *Large Language Model* (LLM) *open-source* yang dirancang khusus untuk memahami konteks, budaya, serta bahasa Indonesia dan bahasa daerah (seperti Jawa, Sunda, Bali, dan Batak).
...
Sebagai BUMN telekomunikasi, Telkom memposisikan dirinya sebagai *Indonesia’s End-to-End AI Ecosystem Enabler*. Melalui inisiatif **AIcosystem**, TLKM mengintegrasikan kapabilitas AI di seluruh lini bisnisnya:
...
Emiten-emiten di atas menawarkan paparan yang beragam terhadap tren AI:
1.  **Infrastruktur Dasar:** TLKM (NeutraDC) dan DCII.
2.  **Platform & Model:** ISAT dan GOTO (Sahabat-AI).
3.  **Distribusi & Implementasi (B2B):** MLPT dan MTDL.
4.  **Aplikasi Imersif:** WIRG.

Perlu diingat bahwa sebagian besar pendapatan utama perusahaan-perusahaan ini masih berasal dari bisnis inti mereka (telekomunikasi, e-commerce, ritel IT). Tren kecerdasan buatan saat ini berfungsi sebagai **katalis pertumbuhan masa depan** yang berpotensi meningkatkan efisiensi dan menciptakan sumber pendapatan baru.

> **Disclaimer:** Artikel ini bertujuan sebagai edukasi dan informasi, bukan rekomendasi jual/beli saham. Investasi saham mengandung risiko. Lakukan riset mandiri sebelum mengambil keputusan finansial.
